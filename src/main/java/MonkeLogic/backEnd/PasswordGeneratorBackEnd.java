...
public class PasswordGeneratorBackEnd {
    ...
    //region Singleton
    private static PasswordGeneratorBackEnd instance;

    public static PasswordGeneratorBackEnd getInstance() {
        if (instance == null) {
            instance = new PasswordGeneratorBackEnd();
        }
        return instance;
    }

    private PasswordGeneratorBackEnd() {
    }
    ...
    public static String generateStrongPassword() {
        ...
        // combine all
        // shuffle again
        System.out.println(shuffleString(password));
